...
class AffinityPropagationSummary:
    ...
    def __str__(self):
        return 'Affinity Propagation algorithm with {} clusters. \n Available attributes: \n {}'.format(self.n_clusters, self.__dict__.keys())
    def __repr__(self):
        return 'Affinity Propagation algorithm with {} clusters. \n Available attributes: \n {}'.format(self.n_clusters, self.__dict__.keys())
