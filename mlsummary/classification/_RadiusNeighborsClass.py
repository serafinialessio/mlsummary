...
class RadiusNeighborsClassSummary:
    ...
    def describe(self):
        print('Radius neighbors classifier algorithm')
        print('------------------')
    ...
    def __str__(self):
        return 'Radius neighbors classifier with {} class \n Available attributes: \n {}'.format(self.n_class, self.__dict__.keys())
    def __repr__(self):
        return 'Radius neighbors classifier with {} class \n Available attributes: \n {}'.format(self.n_class, self.__dict__.keys())
...
class RadiusNeighborsClassSummaryCV(RadiusNeighborsClassSummary):
    def __init__(self, obj, X=None, X_train = None, y_pred=None, y_true=None,
                 y_train = None, y_true_train = None, store_X=False, prob_return=False, digits = 3):
    ...
    def describe(self, cv_result_describe = True, best_model_describe = True):
        print('Cross validation radius neighbors classifier')
        print('------------------')
