...
class GradientBoostingClassSummary:
    def __init__(self, obj, X=None, X_train=None, y_pred=None, y_true=None,
        ...
        self.loss = obj.loss_
        self.ccp_alpha = obj.ccp_alpha
        self.max_depth = obj.max_depth
        self.min_samples_leaf = obj.min_samples_leaf
        self.min_impurity_split = obj.min_impurity_split
...
class GradientBoostingClassSummaryCV(GradientBoostingClassSummary):
    def __init__(self, obj, X=None, X_train = None, y_pred=None, y_true=None,
                 y_train = None, y_true_train = None, store_X=False, prob_return=False, digits = 3):
    ...
    def describe(self, best_model_describe = True):
        print('Cross validation gradient boosting classifier')
        print('------------------')
