...
class NearestCentroidClassSummary:
    ...
    def describe(self):
        print('Nearest Centroid classifier algorithm')
        print('------------------')
...
class NearestCentroidClassSummaryCV(NearestCentroidClassSummary):
    def __init__(self, obj, X=None, X_train = None, y_pred=None, y_true=None,
                 y_train = None, y_true_train = None, store_X=False, prob_return=False, digits = 3):
    ...
    def describe(self, cv_result_describe = True, best_model_describe = True):
        print('Cross validation nearest centroid classifier')
        print('------------------')
